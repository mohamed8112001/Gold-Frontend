      ...
      <div className="w-full h-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch h-full bg-white/80 backdrop-blur-sm">
          ...
          <div className="w-full bg-gradient-to-br from-white to-primary-1 p-8 lg:p-12 flex flex-col justify-center relative order-2 lg:order-1 font-cairo">
            ...
            <div
              className="flex justify-center mb-8 font-cairo text-lg"
              dir="rtl"
            >
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="group" dir="rtl">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pr-14 py-4 border-2 rounded-xl transition-all duration-200 text-arabic-base text-primary-900 text-right placeholder:text-right placeholder:text-primary-400 ${
                        errors.email ? "border-error-500" : "border-secondary-2"
                      }`}
                    />
                  </div>
                  {errors.email && (
                    <p className="text-error-500 text-arabic-sm mt-2 animate-pulse text-right">
                      {errors.email}
                    </p>
                  )}
                </div>
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`pl-14 pr-14 py-4 border-2 rounded-xl transition-all duration-200 text-arabic-base ${
                  ...
                  {errors.password && (
                    <p className="text-red-500 text-arabic-sm mt-2 animate-pulse">
                      {errors.password}
                    </p>
                  )}
                </div>
                ...
                <Button
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #A37F41 0%, #8A6C37 50%, #6D552C 100%)",
                    border: "none",
                  }}
                  onMouseEnter={(e) => {
                    e.target.style.background =
                      "linear-gradient(135deg, #8A6C37 0%, #6D552C 50%, #49391D 100%)";
                  }}
                  onMouseLeave={(e) => {
                    e.target.style.background =
                      "linear-gradient(135deg, #A37F41 0%, #8A6C37 50%, #6D552C 100%)";
                  ...
                  {isLoading ? (
                    <div className="flex items-center justify-center space-x-2">
                      ...
                      <span className="text-button-lg">
                        جاري {t("auth.login.login_button")}...
                      </span>
                    </div>
                  ) : (
                    <span className="text-button-lg">
