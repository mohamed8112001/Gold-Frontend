...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({
        submit: error.message || "فشل في إنشاء الحساب. حاول مرة أخرى",
      });
    }
  };
  ...
  return (
    ...
    >
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="group">
                    ...
                    <Input
                      ...
                      className={`py-3 border-2 rounded-xl transition-all duration-200 text-right ${
                        errors.firstName
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`pl-14 py-4 border-2 rounded-xl transition-all duration-200 text-right ${
                        errors.email
                          ? "border-red-500 bg-red-50"
                          : "border-gray-300 focus:border-amber-500"
                      }`}
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className={`pl-14 pr-14 py-4 border-2 rounded-xl transition-all duration-200 text-right ${
                          errors.password
                            ? "border-red-500 bg-red-50"
                            : "border-gray-300 focus:border-amber-500"
                        }`}
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full text-white py-5 text-lg font-semibold rounded-xl hover:scale-105 transform transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{
                    background:
                      "linear-gradient(135deg, #A37F41 0%, #B8904F 50%, #C9A05D 100%)",
                    border: "none",
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span
                      className="px-6 bg-gradient-to-r from-[#FFF8E6] to-white font-medium"
                      style={{ color: "#8A5700" }}
                    >
                      أو سجل باستخدام
                    </span>
                  ...
                  <GoogleLogin
                    onSuccess={async (credentialResponse) => {
                      try {
                        ...
                        setErrors({
                          submit:
                            "فشل في التسجيل باستخدام Google. حاول مرة أخرى",
                        });
                      }
                    }}
                    onError={() => {
                      ...
                      setErrors({
                        submit: "فشل في التسجيل باستخدام Google",
                      });
                    }}
      ...
      <style jsx>{`
        ...
        .group input:focus {
          outline: none;
          box-shadow: 0 0 0 3px rgba(163, 127, 65, 0.1);
        }

        .group input.border-red-500:focus {
