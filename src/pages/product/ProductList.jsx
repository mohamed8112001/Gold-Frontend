...
const ProductList = () => {
                        ...
                        <div className="fallback-image absolute inset-0 bg-gradient-to-br from-[#FFF0CC] via-[#FFF8E6] to-[#FFE6B3] hidden items-center justify-center group-hover:from-[#FFE6B3] group-hover:via-[#FFF0CC] group-hover:to-[#FFDB99] transition-all duration-700">
                            <div className="text-center transform group-hover:scale-110 transition-transform duration-700">
                                <div className="relative mb-2 sm:mb-4">
                                    <div className="text-4xl sm:text-6xl mb-1 sm:mb-2 filter drop-shadow">💎</div>
    ...
    <div className="relative z-10 w-full px-2 sm:px-4">
                ...
                <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <div className="flex-1 min-w-0">
                        {/* Results Info */}
                        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6 sm:mb-8 bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow border border-gray-100">
                            <div className="flex-1">
        ...
        {t('products.filtered')}
                        ...
                        {isLoading ? (
                            <div className={`grid gap-4 sm:gap-6 ${viewMode === 'grid'
                                ...
                                {[...Array(8)].map((_, index) => (
                                    <div key={index} className="animate-pulse bg-white rounded-2xl shadow overflow-hidden flex flex-col h-full">
