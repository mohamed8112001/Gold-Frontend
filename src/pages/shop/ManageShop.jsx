            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    <p className="text-sm font-medium text-gray-600 mb-1 font-cairo">
                      اسم المتجر
                    </p>
                    <p className="text-gray-900 font-medium font-cairo">
                      {shop?.name || "غير محدد"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div className="md:col-span-2 lg:col-span-3">
                    ...
                    <p className="text-gray-900 font-cairo">
                      {shop?.address || "لم يتم تحديد العنوان"}
                    </p>
                  </div>
                </div>
              </CardContent>
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex gap-2 border-t border-gray-100 pt-3">
                            <Button
                              ...
                              onClick={() =>
                                navigate(ROUTES.PRODUCT_DETAILS(product._id))
                              }
                            >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                navigate(ROUTES.EDIT_PRODUCT(product._id))
                              }
                            >
                              <Edit className="w-4 h-4 ml-1" />
                              تعديل المنتج
                ...
                {bookings.map((booking) => (
                  <Card key={booking.id}>
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-medium font-cairo">
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium font-cairo ${
