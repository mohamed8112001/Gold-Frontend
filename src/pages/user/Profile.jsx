...
const Profile = () => {
  ...
  return (
    <div
      className="w-full min-h-screen bg-[#F8F8F8] pt-20"
      style={{ fontFamily: "'Noto Sans Arabic', sans-serif" }}
    >
            ...
            <Card className="bg-[#F8F8F8] border-[#D4AF37]/30 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 animate-fadeIn">
              <CardHeader className="bg-gradient-to-r from-[#E0C36F]/10 to-[#D4AF37]/10">
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-[#222222] font-bold">
                      المعلومات الشخصية
                    </CardTitle>
              ...
              <CardContent className="p-6 space-y-6">
                      ...
                      <Badge
                        ...
                        className={`${
                          user.role === USER_TYPES.ADMIN
                            ...
                            : user.role === USER_TYPES.SELLER
                            ? "bg-[#D4AF37] hover:bg-[#E0C36F]"
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-[#222222]">
                      {user.bio || "لم يتم إضافة نبذة شخصية"}
                    </p>
                  )}
                </div>
                <div
